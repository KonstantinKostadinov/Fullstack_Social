...
class LoginController: LBTAFormController {
    let logoImageView = UIImageView(image: #imageLiteral(resourceName: "startup"),contentMode: .scaleAspectFill)
    ...
    let errorLabel = UILabel(text: "Your login credentials were uncorrect, please try again.", font: .systemFont(ofSize: 14), textColor: .red, textAlignment: .center, numberOfLines: 0)
